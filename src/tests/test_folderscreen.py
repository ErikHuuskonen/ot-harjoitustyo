...
class TestFolderSelectionScreen(unittest.TestCase):
    ...
    def test_update_folder_list(self):
        ...
        self.assertEqual(len(self.screen.winfo_children()), 3)  # New folder button + 2 folder buttons
    ...
    def test_create_folder(self):
        ...
        self.assertEqual(len(self.screen.winfo_children()), 2)  # New folder button + 1 folder button
